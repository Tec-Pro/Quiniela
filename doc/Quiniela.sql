...
CREATE TABLE clientes (id int auto_increment PRIMARY KEY, nombre varchar(40) NOT NULL, apellido varchar(40) NOT NULL, deber DECIMAL(18,2), saldo DECIMAL(18,2), haber DECIMAL(18,2), visible int);

CREATE TABLE productos (id int auto_increment PRIMARY KEY, nombre varchar(40) NOT NULL, precio DECIMAL(18,2), stock int DEFAULT 0, comision DECIMAL(18,2), diaSorteo DATE NOT NULL DEFAULT '1999-02-02', visible int);
